<h2>234. Palindrome Linked List</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">head</code> of a singly linked list, return <code style="user-select: auto;">true</code> if it is a palindrome.</p>
